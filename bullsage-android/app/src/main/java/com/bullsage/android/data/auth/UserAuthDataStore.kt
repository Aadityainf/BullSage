...
class UserAuthDataStore @Inject constructor(
    ...
    override suspend fun getAuthDetails(): UserAuthDetails? {
    ...
    override suspend fun saveAuthDetails(userAuthDetails: UserAuthDetails) {
    ...
    override suspend fun deleteAuthDetails() {
        preferenceDataStore.edit { preferences ->
